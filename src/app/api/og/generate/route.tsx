...
export async function GET(request: Request) {
  ...
  const authorName = settings.profile.name || person.name;
  const authorRole = settings.profile.role || person.role;
  const authorAvatar = settings.profile.avatar || person.avatar;
